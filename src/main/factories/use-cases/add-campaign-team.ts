...
import { makeCampaignTeamRepository } from '@/main/factories/infra/repo'

export const makeAddCampaignTeamUseCase = (): AddCampaignTeam => {
  return setupAddCampaingTeam(makeAwsS3StorageHandler(), makeUUIDHandler(), makeCampaignTeamRepository())
}
